...
transcribers-by-user = Prikaži prepisivače po korisnicima
transcribers-language-users = { $language } ({ $count } korisnika)
transcribers-language-users-one = { $language } ({ $count } korisnik)
transcribers-user-languages = { $user } ({ $count } jezika)
transcribers-user-languages-one = { $user } ({ $count } jezik)
transcribers-no-users = Nema prepisivača za ovaj jezik.
transcribers-no-languages = Nema jezika koji su dodeljeni ovom korisniku.
transcribers-no-transcribers = Još uvek nema dodeljenih prepisivača.
transcribers-add-user = Dodaj korisnika
transcribers-add-users = Dodaj korisnike
transcribers-add-languages = Dodaj jezike
transcribers-remove-confirm = Da li želite da uklonite { $user } kao prepisivača za { $language }?
transcribers-remove-lang-confirm = Da li želite da uklonite { $language } korisniku { $user }?
transcribers-removed = { $user } je uklonjen kao prepisivač za { $language }.
transcribers-added = { $user } je dodat kao prepisivač za { $language }.
transcribers-users-added = Dodato { $users } kao prepisivači za { $language }.
transcribers-languages-added = Dodat { $user } kao prepisivač za { $languages }.
transcribers-not-fluent = { $user } nema { $language } u listi jezika koje govori i ne može postati prepisivač za taj jezik.
transcribers-no-eligible-users = Nijedan iispravan korisnik nije pronađen. Korisnici moraju da odaberu ovaj jezik u listi jezika koje govore.
transcribers-no-users-to-add = Nema dostupnih korisnika za dodavanje. Svi korisnici sa podešenim jezicima su već prepisivači.
transcribers-no-eligible-languages = Nijedan moguć jezik nije pronađen. Ovaj korisnik nema nedodeljene podešene jezike.
transcribers-remove-transcriber = Ukloni prepisivača
transcribers-remove-all-confirm = Da li želite da uklonite sve dodeljene jezike za prepisvača { $user }?
transcribers-removed-all = Svi dodeljeni jezici prepisivača su uklonjeni korisniku { $user }.

localization-in-progress-try-again = Učitavanje prevoda u toku. Molimo pokušajte ponovo za miut.
