...
monopoly-view-player-properties = Ver propriedades do jogador
...
monopoly-no-players-with-properties = Não há jogadores disponíveis para navegar pelas propriedades.
